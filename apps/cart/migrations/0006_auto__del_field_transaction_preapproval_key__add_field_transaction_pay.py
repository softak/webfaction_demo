...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cart_transaction', 'preapproval_key')

        # Adding field 'Transaction.pay_key'
        db.add_column('cart_transaction', 'pay_key', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Transaction.preapproval_key'
        db.add_column('cart_transaction', 'preapproval_key', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Deleting field 'Transaction.pay_key'
        db.delete_column('cart_transaction', 'pay_key')
