...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PersonalTag.paid'
        db.add_column('cart_personaltag', 'paid', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PersonalTag.paid'
        db.delete_column('cart_personaltag', 'paid')
