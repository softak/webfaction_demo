...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PickupRequest.buy'
        db.add_column('cart_pickuprequest', 'buy', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pickup_requests', null=True, to=orm['cart.SocialBuy']), keep_default=False)

        # Adding field 'PickupRequest.store'
        db.add_column('cart_pickuprequest', 'store', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pickup_requests', null=True, to=orm['stores.Store']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PickupRequest.buy'
        db.delete_column('cart_pickuprequest', 'buy_id')

        # Deleting field 'PickupRequest.store'
        db.delete_column('cart_pickuprequest', 'store_id')
