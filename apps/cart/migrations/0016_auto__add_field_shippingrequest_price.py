...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShippingRequest.price'
        db.add_column('cart_shippingrequest', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShippingRequest.price'
        db.delete_column('cart_shippingrequest', 'price')
