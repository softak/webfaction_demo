...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'SocialTag', fields ['transaction']
        db.delete_unique('cart_socialtag', ['transaction_id'])

        # Removing unique constraint on 'PersonalTag', fields ['transaction']
        db.delete_unique('cart_personaltag', ['transaction_id'])

        # Changing field 'PersonalTag.transaction'
        db.alter_column('cart_personaltag', 'transaction_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cart.Transaction']))

        # Changing field 'SocialTag.transaction'
        db.alter_column('cart_socialtag', 'transaction_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cart.Transaction']))


    def backwards(self, orm):
        
        # Changing field 'PersonalTag.transaction'
        db.alter_column('cart_personaltag', 'transaction_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cart.Transaction'], unique=True, null=True))

        # Adding unique constraint on 'PersonalTag', fields ['transaction']
        db.create_unique('cart_personaltag', ['transaction_id'])

        # Changing field 'SocialTag.transaction'
        db.alter_column('cart_socialtag', 'transaction_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cart.Transaction'], unique=True, null=True))

        # Adding unique constraint on 'SocialTag', fields ['transaction']
        db.create_unique('cart_socialtag', ['transaction_id'])
    ...
    models = {
        ...
        'cart.personaltag': {
            ...
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'personal_tags'", 'null': 'True', 'to': "orm['cart.Transaction']"}),
        ...
        'cart.socialtag': {
            ...
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'social_tags'", 'null': 'True', 'to': "orm['cart.Transaction']"}),
