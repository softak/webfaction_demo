...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PickupRequest.transaction'
        db.add_column('cart_pickuprequest', 'transaction', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pickup_requests', null=True, to=orm['cart.Transaction']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PickupRequest.transaction'
        db.delete_column('cart_pickuprequest', 'transaction_id')
