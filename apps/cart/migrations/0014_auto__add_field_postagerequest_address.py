...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostageRequest.address'
        db.add_column('cart_postagerequest', 'address', self.gf('django.db.models.fields.CharField')(default='test', max_length='2000'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PostageRequest.address'
        db.delete_column('cart_postagerequest', 'address')
    ...
    models = {
        ...
        'cart.socialtag': {
            ...
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['stores.Item']"}),
            'paid': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'postage_request': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'social_tags'", 'null': 'True', 'to': "orm['cart.PostageRequest']"}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cart.Transaction']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
