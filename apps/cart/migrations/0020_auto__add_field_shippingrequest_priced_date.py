...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShippingRequest.priced_date'
        db.add_column('cart_shippingrequest', 'priced_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShippingRequest.priced_date'
        db.delete_column('cart_shippingrequest', 'priced_date')
