...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostageRequest.price'
        db.alter_column('cart_postagerequest', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PostageRequest.sent_date'
        db.alter_column('cart_postagerequest', 'sent_date', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PostageRequest.price'
        raise RuntimeError("Cannot reverse this migration. 'PostageRequest.price' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PostageRequest.sent_date'
        raise RuntimeError("Cannot reverse this migration. 'PostageRequest.sent_date' and its values cannot be restored.")
    ...
    models = {
        ...
        'cart.postagerequest': {
            'Meta': {'object_name': 'PostageRequest'},
            'buy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'postage_requests'", 'to': "orm['cart.SocialBuy']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cart.socialtag': {
            ...
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['stores.Item']"}),
            'paid': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'postage_request': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'social_tags'", 'null': 'True', 'to': "orm['cart.PostageRequest']"}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cart.Transaction']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
