...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cart_paymentrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transaction', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_requests', to=orm['cart.Transaction'])),
            ('currency_code', self.gf('django.db.models.fields.CharField')(default='USD', max_length='3')),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('seller_paypal_account_id', self.gf('django.db.models.fields.CharField')(max_length='100')),
            ('payment_request_id', self.gf('django.db.models.fields.CharField')(max_length='100')),
        ))
        db.send_create_signal('cart', ['PaymentRequest'])


    def backwards(self, orm):
        
        # Deleting model 'PaymentRequest'
        db.delete_table('cart_paymentrequest')
