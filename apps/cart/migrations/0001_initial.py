...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PersonalTag'
        db.create_table('cart_personaltag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='personal_tags', to=orm['auth.User'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='personal_tags', to=orm['stores.Item'])),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('cart', ['PersonalTag'])


    def backwards(self, orm):
        
        # Deleting model 'PersonalTag'
        db.delete_table('cart_personaltag')
