...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'PostageRequest'
        db.delete_table('cart_postagerequest')

        # Adding model 'ShippingRequest'
        db.create_table('cart_shippingrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('transaction', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shipping_requests', null=True, to=orm['cart.Transaction'])),
        ...
        db.send_create_signal('cart', ['ShippingRequest'])

        # Adding model 'PickupRequest'
        db.create_table('cart_pickuprequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('pickup_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('cart', ['PickupRequest'])

        # Deleting field 'SocialTag.postage_request'
        db.delete_column('cart_socialtag', 'postage_request_id')

        # Adding field 'SocialTag.shipping_request'
        db.add_column('cart_socialtag', 'shipping_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cart.ShippingRequest'], null=True, blank=True), keep_default=False)

        # Adding field 'SocialTag.pickup_request'
        db.add_column('cart_socialtag', 'pickup_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cart.PickupRequest'], null=True, blank=True), keep_default=False)

        # Adding field 'PersonalTag.shipping_request'
        db.add_column('cart_personaltag', 'shipping_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cart.ShippingRequest'], null=True, blank=True), keep_default=False)

        # Adding field 'PersonalTag.pickup_request'
        db.add_column('cart_personaltag', 'pickup_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cart.PickupRequest'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'PostageRequest'
        db.create_table('cart_postagerequest', (
            ('buy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='postage_requests', to=orm['cart.SocialBuy'])),
            ('sent_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal('cart', ['PostageRequest'])

        # Deleting model 'ShippingRequest'
        db.delete_table('cart_shippingrequest')

        # Deleting model 'PickupRequest'
        db.delete_table('cart_pickuprequest')

        # Adding field 'SocialTag.postage_request'
        db.add_column('cart_socialtag', 'postage_request', self.gf('django.db.models.fields.related.ForeignKey')(related_name='social_tags', null=True, to=orm['cart.PostageRequest'], blank=True), keep_default=False)

        # Deleting field 'SocialTag.shipping_request'
        db.delete_column('cart_socialtag', 'shipping_request_id')

        # Deleting field 'SocialTag.pickup_request'
        db.delete_column('cart_socialtag', 'pickup_request_id')

        # Deleting field 'PersonalTag.shipping_request'
        db.delete_column('cart_personaltag', 'shipping_request_id')

        # Deleting field 'PersonalTag.pickup_request'
        db.delete_column('cart_personaltag', 'pickup_request_id')
