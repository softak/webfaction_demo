...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cart_socialtag', 'postage_request', self.gf('django.db.models.fields.related.ForeignKey')(related_name='social_tags', null=True, to=orm['cart.PostageRequest']), keep_default=False)
