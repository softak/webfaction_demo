...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.payment_details'
        db.add_column('cart_transaction', 'payment_details', self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Transaction.payment_details'
        db.delete_column('cart_transaction', 'payment_details')
