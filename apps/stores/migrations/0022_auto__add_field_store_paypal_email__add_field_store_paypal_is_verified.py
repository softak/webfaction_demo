...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Store.paypal_email'
        db.add_column('stores_store', 'paypal_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Store.paypal_email'
        db.delete_column('stores_store', 'paypal_email')
