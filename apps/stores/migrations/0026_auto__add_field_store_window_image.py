...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Store.window_image'
        db.add_column('stores_store', 'window_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Store.window_image'
        db.delete_column('stores_store', 'window_image')
    ...
    models = {
        ...
        'stores.store': {
            ...
            'window_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'})
        }
    }
