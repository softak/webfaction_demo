...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('stores_item', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))


    def backwards(self, orm):
        
        # Changing field 'Item.description'
        db.alter_column('stores_item', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
