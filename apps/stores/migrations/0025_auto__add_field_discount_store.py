...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Discount.store'
        db.add_column('stores_discount', 'store', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='discount_models', to=orm['stores.Store']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Discount.store'
        db.delete_column('stores_discount', 'store_id')
