...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('stores_item', 'quantity', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Item.is_out_of_stock'
        db.add_column('stores_item', 'is_out_of_stock', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.quantity'
        db.delete_column('stores_item', 'quantity')

        # Deleting field 'Item.is_out_of_stock'
        db.delete_column('stores_item', 'is_out_of_stock')
