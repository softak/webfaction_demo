...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DiscountGroup'
        db.create_table('stores_discountgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('discount', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discount_groups', to=orm['stores.Discount'])),
        ))
        db.send_create_signal('stores', ['DiscountGroup'])

        # Adding field 'Item.discount_group'
        db.add_column('stores_item', 'discount_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', null=True, to=orm['stores.DiscountGroup']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'DiscountGroup'
        db.delete_table('stores_discountgroup')

        # Deleting field 'Item.discount_group'
        db.delete_column('stores_item', 'discount_group_id')
