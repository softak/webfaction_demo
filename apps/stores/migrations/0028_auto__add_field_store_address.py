...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Store.address'
        db.add_column('stores_store', 'address', self.gf('django.db.models.fields.CharField')(default='test', max_length=1000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Store.address'
        db.delete_column('stores_store', 'address')
