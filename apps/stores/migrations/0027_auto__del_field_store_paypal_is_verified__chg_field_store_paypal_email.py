...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Store.paypal_is_verified'
        db.delete_column('stores_store', 'paypal_is_verified')

        # Changing field 'Store.paypal_email'
        db.alter_column('stores_store', 'paypal_email', self.gf('django.db.models.fields.EmailField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Adding field 'Store.paypal_is_verified'
        db.add_column('stores_store', 'paypal_is_verified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Store.paypal_email'
        raise RuntimeError("Cannot reverse this migration. 'Store.paypal_email' and its values cannot be restored.")
